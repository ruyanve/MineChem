...
public class TileEntitySynthesis extends MinechemTileEntity implements IPowerReceptor, ITriggerProvider, IMinechemTriggerProvider, ISpecialInventory, IMinechemMachinePeripheral {
	...
	public ElectricityPack getRequest() {
		return new ElectricityPack((float) (Math.min((powerProvider.getMaxEnergyStored() - powerProvider.getEnergyStored()), powerProvider.getMaxEnergyReceived()) * 437.5D / this.getVoltage()), this.getVoltage());
	}
