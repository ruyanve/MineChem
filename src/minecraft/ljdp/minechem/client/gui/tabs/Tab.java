...
public abstract class Tab {
    ...
    protected void drawBackground(int x, int y) {
        ...
        if (leftSide) {
            renderEngine.func_110577_a(new ResourceLocation(ConstantValue.TAB_LEFT));
            ...
            renderEngine.func_110577_a(new ResourceLocation(ConstantValue.TAB_RIGHT));
    ...
    protected void drawIcon(Icon icon, int x, int y) {
        Minecraft.getMinecraft().renderEngine.func_110577_a(new ResourceLocation("/gui/items.png"));
        GL11.glColor4f(1.0f, 1.0f, 1.0f, 1.0F);
