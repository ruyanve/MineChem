...
public final class RefineryRecipes {
	...
	public static final class Recipe implements Comparable<Recipe> {
		...
		private Recipe(@Nullable FluidStack ingredient1, FluidStack ingredient2, FluidStack result, int energy, int delay) {
			if (ingredient1 == null)
		...
		public boolean matches(@Nullable FluidStack liquid1, @Nullable FluidStack liquid2) {
		...
		@Override
		public int compareTo(@Nullable Recipe other) {
			if (other == null)
				return -1;
