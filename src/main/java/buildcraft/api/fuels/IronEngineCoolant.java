...
public final class IronEngineCoolant {
	...
	@Nullable
	public static Coolant getCoolant(@Nullable FluidStack fluidStack) {
	...
	public static void addCoolant(@Nullable final Fluid fluid, final float degreesCoolingPerMB) {
		if (fluid != null) {
	 ...
	 * @param coolant
	 */
	public static void addCoolant(@Nullable final ItemStack stack, @Nullable final FluidStack coolant) {
	...
	public static boolean isCoolant(@NotNull Fluid fluid) {
