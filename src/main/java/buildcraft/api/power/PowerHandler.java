...
//	private long startTime = -1;
	 ...
	 * @param perdition
	 */
	public void setPerdition(@Nullable PerditionCalculator perdition) {
		if (perdition == null)
...
//		}
	...
	private void updateSources(@Nullable ForgeDirection source) {
...
//			totalUsedPower += result;
	...
	public void readFromNBT(@NotNull NBTTagCompound data, String tag) {
	...
	public void writeToNBT(@NotNull NBTTagCompound data, String tag) {
...
//			totalReceivedPower += used;
	...
	public boolean isPowerSource(@NotNull ForgeDirection from) {
