...
public class BptBlock {
	 ...
	 * buildBlock.
	 */
	public void addRequirements(@NotNull BptSlotInfo slot, IBptContext context, @NotNull LinkedList<ItemStack> requirements) {
		if (slot.blockId != 0) {
	 ...
	 */
	public ItemStack useItem(BptSlotInfo slot, IBptContext context, @NotNull ItemStack req, @NotNull ItemStack stack) {
	 ...
	 */
	public boolean isValid(@NotNull BptSlotInfo slot, @NotNull IBptContext context) {
	 ...
	 */
	public void buildBlock(@NotNull BptSlotInfo slot, @NotNull IBptContext context) {
	 ...
	 */
	public void initializeFromWorld(@NotNull BptSlotInfo slot, @NotNull IBptContext context, int x, int y, int z) {
		if (Block.blocksList[slot.blockId] instanceof BlockContainer) {
	 ...
	 */
	public BlockSignature getSignature(@NotNull Block block) {
	 ...
	 */
	public boolean match(@Nullable Block block, @NotNull BlockSignature sig) {
		if (block == null)
			return false;
	...
	private boolean starMatch(@NotNull String s1, @NotNull String s2) {
