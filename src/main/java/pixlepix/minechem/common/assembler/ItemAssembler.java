...
public class ItemAssembler extends Item {
	...
	@Override
	public boolean onItemUseFirst(@NotNull ItemStack stack, @NotNull EntityPlayer player, World world, int x, int y, int z, int side, float hitX, float hitY, float hitZ) {
