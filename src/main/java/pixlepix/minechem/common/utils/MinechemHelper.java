...
public class MinechemHelper {
	...
	public static int getSplitStringHeight(@NotNull FontRenderer fontRenderer, String string, int width) {
	...
	@NotNull
	public static NBTTagList writeItemStackArrayToTagList(@NotNull ItemStack[] itemstacks) {
	...
	public static ItemStack[] readTagListToItemStackArray(@NotNull NBTTagList taglist, ItemStack[] itemstacks) {
	...
	@NotNull
	public static NBTTagList writeItemStackListToTagList(@NotNull ArrayList<ItemStack> list) {
		NBTTagList taglist = new NBTTagList();
	...
	@NotNull
	public static ArrayList<ItemStack> readTagListToItemStackList(@NotNull NBTTagList taglist) {
	...
	@NotNull
	public static ArrayList<ItemStack> convertChemicalsIntoItemStacks(@Nullable ArrayList<Chemical> chemicals) {
	...
	@NotNull
	public static ItemStack[] convertChemicalArrayIntoItemStackArray(@NotNull Chemical[] chemicals) {
	...
	public static boolean itemStackMatchesChemical(@NotNull ItemStack itemstack, Chemical chemical) {
		return itemStackMatchesChemical(itemstack, chemical, 1);
	}

	public static boolean itemStackMatchesChemical(@NotNull ItemStack itemstack, Chemical chemical, int factor) {
	...
	public static void ejectItemStackIntoWorld(@NotNull ItemStack itemstack, World world, int x, int y, int z) {
	...
	public static TileEntity getTile(@NotNull World world, Position pos, ForgeDirection dir) {
	...
	@Nullable
	public static Chemical itemStackToChemical(@NotNull ItemStack itemstack) {
