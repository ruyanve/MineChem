...
public class Transactor {
	...
	public int add(@NotNull ItemStack var1, boolean var2) {
		int var3 = 0;
	...
	public int putStackInSlot(@NotNull ItemStack var1, int var2, int var3, boolean var4) {
	...
	public int getMaxStackSize(@NotNull ItemStack var1) {
