...
public class ItemMolecule extends Item {
	...
	public ArrayList<ItemStack> getElements(@NotNull ItemStack itemstack) {
	...
	public String getFormula(@NotNull ItemStack itemstack) {
	...
	public String getFormulaWithSubscript(@NotNull ItemStack itemstack) {
	...
	@Override
	@SideOnly(Side.CLIENT)
	public void addInformation(@NotNull ItemStack par1ItemStack, EntityPlayer par2EntityPlayer, @NotNull List par3List, boolean par4) {
	...
	@Nullable
	public static EnumMolecule getMolecule(@NotNull ItemStack itemstack) {
	...
	@NotNull
	@Override
	public ItemStack onEaten(@NotNull ItemStack itemStack, @NotNull World world, EntityPlayer entityPlayer) {
	...
	@Override
	public ItemStack onItemRightClick(ItemStack par1ItemStack, World par2World, @NotNull EntityPlayer par3EntityPlayer) {
