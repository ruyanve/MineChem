...
public class ConfigurableRecipies {
	...
	public static void loadConfigurableRecipies(@NotNull Configuration config) {
		config.load();
	...
	public static void makeDummyRecipe(@NotNull Configuration config) {
	...
	public static int parseId(@NotNull String s) {
		String ns = s;
		if (s.contains(":")) {
			ns = s.split(":")[0];
		}
	...
	public static int parseMeta(@NotNull String s) {
