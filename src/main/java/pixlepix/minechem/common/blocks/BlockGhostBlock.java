...
public class BlockGhostBlock extends BlockContainer {
	...
	@Override
	public boolean onBlockActivated(@NotNull World world, int x, int y, int z, @NotNull EntityPlayer entityPlayer, int side, float par7, float par8, float par9) {
	...
	private boolean playerIsHoldingItem(@NotNull EntityPlayer entityPlayer, @NotNull ItemStack itemstack) {
