...
public class TileEntityBlueprintProjector extends MinechemTileEntity {
	...
	private void buildStructure(@NotNull LocalPosition position) {
	...
	@Nullable
	private TileEntity buildManagerBlock(@NotNull LocalPosition position) {
	...
	private void setBlock(int x, int y, int z, @NotNull LocalPosition position, int structureId, @NotNull HashMap<Integer, BlueprintBlock> blockLookup,
	...
	@NotNull
	private BlockStatus projectGhostBlock(int x, int y, int z, @NotNull LocalPosition position) {
		Pos3 worldPos = position.getLocalPos(x, y, z);
	...
	private void destroyGhostBlock(int x, int y, int z, @NotNull LocalPosition position) {
		Pos3 worldPos = position.getLocalPos(x, y, z);
		int blockID = worldObj.getBlockId(worldPos.x, worldPos.y, worldPos.z);
	...
	public void setBlueprint(@Nullable MinechemBlueprint blueprint) {
		if (blueprint != null) {
