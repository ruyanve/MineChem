...
public class ContainerWithFakeSlots extends Container {
	...
	@Nullable
	@Override
	public ItemStack slotClick(int slotNum, int mouseButton, int isShiftPressed, @NotNull EntityPlayer entityPlayer) {
		Slot slot = null;
	...
	private void addStackToSlot(@NotNull ItemStack stackOnMouse, @NotNull Slot slot, int amount) {
