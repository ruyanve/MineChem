...
public class SynthesisRecipe {
	...
	public static void remove(@NotNull ItemStack itemStack) {
	...
	@NotNull
	public static ArrayList<SynthesisRecipe> search(@NotNull ItemStack itemStack) {
	...
	public SynthesisRecipe(ItemStack var1, boolean var2, int var3, @NotNull Chemical... var4) {
		this.output = var1;
		this.isShaped = var2;
	...
	public SynthesisRecipe(ItemStack var1, boolean var2, int var3, @NotNull ArrayList var4) {
		this.output = var1;
		this.isShaped = var2;
		this.energyCost = var3;
