...
public class ItemMoleculeRenderer implements IItemRenderer {
	...
	private void renderItemInInventory(ItemRenderType type, ItemStack itemstack, @NotNull Icon testtube, @NotNull Icon pass1, @NotNull Icon pass2) {
	...
	private void renderItemInEquipped(ItemRenderType type, ItemStack itemstack, @NotNull Icon testtube, @NotNull Icon pass1, @NotNull Icon pass2) {
		EnumMolecule molecule = ItemMolecule.getMolecule(itemstack);
		/*
	...
	private void renderItemAsEntity(ItemRenderType type, ItemStack itemstack, @NotNull Icon testtube, @NotNull Icon pass1, @NotNull Icon pass2) {
		EnumMolecule molecule = ItemMolecule.getMolecule(itemstack);
		GL11.glPushMatrix();
		GL11.glColor3f(molecule.red, molecule.green, molecule.blue);
	...
	private void drawTexturedRectUV(ItemRenderType type, float x, float y, float z, float w, float h, @NotNull Icon icon) {
		Tessellator tesselator = Tessellator.instance;
