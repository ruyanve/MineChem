...
public abstract class GuiContainerTabbed extends GuiMinechemContainer implements INEIGuiHandler {
	...
	/* DRAW FUNCTIONS */
	protected void drawColoredSlot(int x, int y, @NotNull SlotColor color, @NotNull SlotType type, @NotNull SlotRender render) {
	...
	protected void drawColoredSlotNoBorder(int x, int y, @NotNull SlotColor color, @NotNull SlotType type, @NotNull SlotRender render) {
	...
	protected void drawColoredSlotWithBorder(int x, int y, @NotNull SlotColor color, @NotNull SlotType type, @NotNull SlotRender render) {
	...
	protected void drawColoredLiquidSlot(int x, int y, @NotNull SlotColor color) {
	...
	protected void drawColoredLiquidSlotNoBorder(int x, int y, @NotNull SlotColor color) {
	...
	protected void drawColoredLiquidSlotWithBorder(int x, int y, @NotNull SlotColor color) {
	...
	@NotNull
	@Override
	public VisiblityData modifyVisiblity(GuiContainer gui, @NotNull VisiblityData currentVisibility) {
