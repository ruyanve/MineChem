...
public abstract class GuiMinechemContainer extends GuiScreen {
	...
	protected void drawItemStackTooltip(@NotNull ItemStack par1ItemStack, int par2, int par3) {
		GL11.glDisable(GL12.GL_RESCALE_NORMAL);
		RenderHelper.disableStandardItemLighting();
		GL11.glDisable(GL11.GL_LIGHTING);
		GL11.glDisable(GL11.GL_DEPTH_TEST);
	 ...
	 */
	protected void drawSlotInventory(@NotNull Slot par1Slot) {
	...
	private boolean func_92031_b(@Nullable Slot par1Slot) {
	 ...
	 */
	private boolean isMouseOverSlot(@NotNull Slot par1Slot, int par2, int par3) {
	...
	protected void handleMouseClick(@Nullable Slot par1Slot, int par2, int par3, int par4) {
		if (par1Slot != null) {
