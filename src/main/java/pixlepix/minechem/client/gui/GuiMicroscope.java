...
public class GuiMicroscope extends GuiContainerTabbed {
	...
	private void drawSynthesisRecipeMatrix(@NotNull SynthesisRecipe recipe, int x, int y) {
	...
	private void drawSynthesisRecipeCost(@NotNull SynthesisRecipe recipe, int x, int y) {
	...
	private void drawDecomposerRecipeMatrix(@NotNull ArrayList<ItemStack> output, int x, int y) {
		int slot = 2;
	...
	private void drawDecomposerRecipeSelectMatrix(@NotNull ArrayList<DecomposerRecipe> recipes, int x, int y) {
