...
public class GuiChemistJournal extends GuiContainerTabbed implements IVerticalScrollContainer {
	...
	public GuiChemistJournal(@NotNull EntityPlayer entityPlayer) {
	...
	public void populateItemList(@NotNull List<ItemStack> items, EntityPlayer player) {
		int i = 0;
		int j = 0;
	...
	public void onSlotClick(@NotNull GuiFakeSlot slot) {
	...
	public void showSynthesisRecipe(@NotNull SynthesisRecipe recipe) {
	...
	private void showDecomposerRecipeSelect(@NotNull DecomposerRecipeSelect recipe) {
	...
	private void showIngredients(@NotNull ItemStack[] ingredients, GuiFakeSlot[] slotArray, int xOffset, int yOffset) {
		int pos = 0;
		int i = 0;
		int j = 0;
		int x, y;
