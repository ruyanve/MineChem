...
public class RenderGUIItemMicroscope extends RenderItem {
	...
	public RenderGUIItemMicroscope(@NotNull GuiMicroscope guiMicroscope) {
		super();
	...
	@Override
	public void renderItemAndEffectIntoGUI(FontRenderer par1FontRenderer, TextureManager par2RenderEngine, @Nullable ItemStack itemstack, int x, int y) {
		if (itemstack == null)
			return;
	...
	@Override
	public void renderItemOverlayIntoGUI(FontRenderer par1FontRenderer, TextureManager par2RenderEngine, @Nullable ItemStack itemstack, int par4, int par5) {
		if (itemstack == null)
			return;
