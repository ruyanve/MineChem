...
public class Vector3 implements Cloneable {
	...
	public Vector3(@NotNull Entity par1) {
		this(par1.posX, par1.posY, par1.posZ);
	}

	public Vector3(@NotNull TileEntity par1) {
		this(par1.xCoord, par1.yCoord, par1.zCoord);
	}

	public Vector3(@NotNull Vec3 par1) {
		this(par1.xCoord, par1.yCoord, par1.zCoord);

	}

	public Vector3(@NotNull MovingObjectPosition par1) {
		this(par1.blockX, par1.blockY, par1.blockZ);
	}

	public Vector3(@NotNull ChunkCoordinates par1) {
		this(par1.posX, par1.posY, par1.posZ);
	}

	public Vector3(@NotNull ForgeDirection direction) {
	 ...
	 */
	public Vector3(@NotNull NBTTagCompound nbt) {
	 ...
	 * @return
	 */
	public int getBlockID(@NotNull IBlockAccess world) {
		return world.getBlockId(this.intX(), this.intY(), this.intZ());
	}

	public int getBlockMetadata(@NotNull IBlockAccess world) {
		return world.getBlockMetadata(this.intX(), this.intY(), this.intZ());
	}

	public TileEntity getTileEntity(@NotNull IBlockAccess world) {
		return world.getBlockTileEntity(this.intX(), this.intY(), this.intZ());
	}

	public boolean setBlock(@NotNull World world, int id, int metadata, int notify) {
		return world.setBlock(this.intX(), this.intY(), this.intZ(), id, metadata, notify);
	}

	public boolean setBlock(@NotNull World world, int id, int metadata) {
		return this.setBlock(world, id, metadata, 3);
	}

	public boolean setBlock(@NotNull World world, int id) {
	 ...
	 * @return The distance
	 */
	public static double distance(@NotNull Vector3 vec1, @NotNull Vector3 vec2) {
		return vec1.distance(vec2);
	}

	@Deprecated
	public double distanceTo(@NotNull Vector3 vector3) {
		return this.distance(vector3);
	}

	public double distance(@NotNull Vector3 compare) {
	...
	@NotNull
	public Vector3 translate(@NotNull Vector3 par1) {
		this.x += par1.x;
		this.y += par1.y;
		this.z += par1.z;
		return this;
	...
	@NotNull
	public static Vector3 translate(@NotNull Vector3 translate, @NotNull Vector3 par1) {
		translate.x += par1.x;
		translate.y += par1.y;
		translate.z += par1.z;
		return translate;
	...
	@NotNull
	public static Vector3 translate(@NotNull Vector3 translate, double par1) {
		translate.x += par1;
		translate.y += par1;
		translate.z += par1;
		return translate;
	...
	@NotNull
	@Deprecated
	public Vector3 add(@NotNull Vector3 amount) {
	...
	@NotNull
	@Deprecated
	public Vector3 subtract(@NotNull Vector3 amount) {
	...
	@NotNull
	public Vector3 difference(@NotNull Vector3 amount) {
		return this.translate(amount.clone().invert());
	}
	...
	@NotNull
	public Vector3 scale(@NotNull Vector3 amount) {
		this.x *= amount.x;
		this.y *= amount.y;
		this.z *= amount.z;
		return this;
	...
	@NotNull
	public static Vector3 scale(@NotNull Vector3 vec, double amount) {
		return vec.scale(amount);
	}

	@NotNull
	public static Vector3 scale(@NotNull Vector3 vec, @NotNull Vector3 amount) {
		return vec.scale(amount);
	}
	...
	@NotNull
	@Deprecated
	public Vector3 multiply(@NotNull Vector3 amount) {
		return this.scale(amount);
	}
	...
	@NotNull
	@Deprecated
	public static Vector3 subtract(@NotNull Vector3 par1, @NotNull Vector3 par2) {
		return new Vector3(par1.x - par2.x, par1.y - par2.y, par1.z - par2.z);
	}

	@NotNull
	@Deprecated
	public static Vector3 add(@NotNull Vector3 par1, @NotNull Vector3 par2) {
		return new Vector3(par1.x + par2.x, par1.y + par2.y, par1.z + par2.z);
	}

	@NotNull
	@Deprecated
	public static Vector3 add(@NotNull Vector3 par1, double par2) {
		return new Vector3(par1.x + par2, par1.y + par2, par1.z + par2);
	}

	@NotNull
	@Deprecated
	public static Vector3 multiply(@NotNull Vector3 vec1, @NotNull Vector3 vec2) {
		return new Vector3(vec1.x * vec2.x, vec1.y * vec2.y, vec1.z * vec2.z);
	}

	@NotNull
	@Deprecated
	public static Vector3 multiply(@NotNull Vector3 vec1, double vec2) {
	 ...
	 */
	public List<Entity> getEntitiesWithin(@NotNull World worldObj, Class<? extends Entity> par1Class) {
	 ...
	 */
	@NotNull
	public Vector3 modifyPositionFromSide(@NotNull ForgeDirection side, double amount) {
		return this.translate(new Vector3(side).scale(amount));
	}

	@NotNull
	public Vector3 modifyPositionFromSide(@NotNull ForgeDirection side) {
	 ...
	 */
	@NotNull
	public Vector3 toCrossProduct(@NotNull Vector3 compare) {
	...
	@NotNull
	public Vector3 crossProduct(@NotNull Vector3 compare) {
	...
	public double dotProduct(@NotNull Vector3 vec2) {
	 ...
	 */
	@NotNull
	public Vector3 rotate(float angle, @NotNull Vector3 axis) {
	...
	@NotNull
	public static Vector3 translateMatrix(double[] matrix, @NotNull Vector3 translation) {
	...
	@NotNull
	public static double[] getRotationMatrix(float angle, @NotNull Vector3 axis) {
	 ...
	 */
	public double getAngle(@NotNull Vector3 vec2) {
		return anglePreNorm(this.clone().normalize(), vec2.clone().normalize());
	}

	public static double getAngle(@NotNull Vector3 vec1, @NotNull Vector3 vec2) {
		return vec1.getAngle(vec2);
	}

	public double anglePreNorm(@NotNull Vector3 vec2) {
		return Math.acos(this.dotProduct(vec2));
	}

	public static double anglePreNorm(@NotNull Vector3 vec1, @NotNull Vector3 vec2) {
	...
	@NotNull
	@Deprecated
	public static Vector3 readFromNBT(@NotNull NBTTagCompound nbt) {
	 ...
	 */
	@Nullable
	public MovingObjectPosition rayTrace(@NotNull World world, float rotationYaw, float rotationPitch, boolean collisionFlag, double reachDistance) {
	...
	public MovingObjectPosition rayTraceBlocks(@NotNull World world, float rotationYaw, float rotationPitch, boolean collisionFlag, double reachDistance) {
	...
	@Nullable
	@Deprecated
	public MovingObjectPosition rayTraceEntities(@NotNull World world, float rotationYaw, float rotationPitch, boolean collisionFlag, double reachDistance) {
		return this.rayTraceEntities(world, rotationYaw, rotationPitch, reachDistance);
	}

	@Nullable
	public MovingObjectPosition rayTraceEntities(@NotNull World world, float rotationYaw, float rotationPitch, double reachDistance) {
	 ...
	 */
	@Nullable
	public MovingObjectPosition rayTraceEntities(@NotNull World world, @NotNull Vector3 target) {
