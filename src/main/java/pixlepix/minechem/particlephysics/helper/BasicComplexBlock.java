...
public abstract class BasicComplexBlock extends Block implements IBlock {
	...
	@Override
	public void breakBlock(@NotNull World world, int x, int y, int z, int oldBlockId, int oldMetadata) {
	...
	@Override
	@SideOnly(Side.CLIENT)
	public void registerIcons(@NotNull IconRegister par1IconRegister) {
	...
	@Override
	public void onBlockPlacedBy(@NotNull World par1World, int x, int y, int z, @NotNull EntityLivingBase par5EntityLiving, ItemStack par6ItemStack) {
